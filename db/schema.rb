...
ActiveRecord::Schema[7.0].define(version: 2022_11_09_123829) do
  ...
  create_table "fact_results", force: :cascade do |t|
    ...
    t.index ["search_id"], name: "index_fact_results_on_search_id"
  end
  ...
  add_foreign_key "fact_results", "searches"
